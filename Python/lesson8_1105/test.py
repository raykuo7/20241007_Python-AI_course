...
class Window(ThemedTk):
    def __init__(self,*args, **kwargs):
        ...
        sitenames_cb = ttk.Combobox(self.selectedFrame, textvariable= self.selected_county,state='readonly')
        ...
        self.li = ['']
        self.var = tk.Variable(value=self.li)
        # self.sitenameFrame = view.SitenameFrame(master=self.selectedFrame,sitenames=self.var)

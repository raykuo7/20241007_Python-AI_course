...
class Window(ThemedTk):
    def __init__(self,*args,**kwargs):
        ...
        bottomFrame = ttk.Frame(self,borderwidth=1,height=1000,relief='groove')
        ...
        btna2.pack(fill='x', padx=10, pady=(5, 5), ipady=30)
        btna3 = ttk.Button(f1,text="按鈕3")
        btna3.pack(fill='x', padx=10, pady=(5, 5), ipady=50)
